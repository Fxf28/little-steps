<section id="about" class="bg-white dark:bg-gray-900 p-4 md:p-8 lg:p-10">
    <div class="flex flex-col items-center justify-center py-8 px-4 mx-auto mb-4 max-w-screen-xl sm:py-16 lg:px-6">
        <div class="max-w-screen-md mb-8 lg:mb-16 text-center">
            <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">About</h2>
