<section id="hero" class="hero">
    <div id="carouselExampleCaptions" class="relative" data-twe-carousel-init data-twe-ride="carousel">
        ...
        <!--Carousel controls-->
        <button class="absolute bottom-0 left-0 top-0 z-[1] flex w-[15%] items-center justify-center text-white opacity-50 transition-opacity hover:opacity-90"
        ...
        <button class="absolute bottom-0 right-0 top-0 z-[1] flex w-[15%] items-center justify-center text-white opacity-50 transition-opacity hover:opacity-90"
