<section>
    <nav class="bg-white dark:bg-gray-800 fixed w-full z-20 top-0 start-0 border-b border-gray-200 dark:border-gray-600">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            <a href="{{ request()->is('/') ? '#' : url('/') }}" class="flex items-center space-x-3 rtl:space-x-reverse">
                <img src="{{ asset('gambar/nest.png') }}" class="h-8" alt="Baby-fuel Logo" loading="lazy">
                <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Baby Fuel</span>
            </a>
                    ...
                    <li>
                        <a href="{{ request()->is('/') ? '#' : url('/') }}"
                            class="block py-2 px-3 rounded md:p-0 
                                   {{ request()->is('/') || request()->is('home') ? 'active text-white bg-blue-700' : 'text-gray-900 hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white' }}"
                            aria-current="{{ request()->is('/') || request()->is('home') ? 'page' : '' }}">
                            Home
                        </a>
                    </li>
                    <li>
